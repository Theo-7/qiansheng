...
$cfg_delete = 'Y';
$cfg_keywords = '电线|电缆';
$cfg_description = '深圳百强科技有限公司成立于2009年，是弹簧线、电源线、DC线生产厂家。产品广泛用于电子、电器、电脑、电讯、医疗仪器等行业。产品均符合安全和环保认证要求。 
公司秉承“ 专心、专注、专业、制造生产高品质线材”的经营理念，所有的努力只为得到客户的赞许。怀着诚挚的心工作，带着快乐的心情广交天下朋友。坚信优质的产品，合理的价格，真诚的服务是双方长期稳定合作愉快的基础，期待和您携手开创新的未来。';
$cfg_beian = '';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
...
$cfg_dz = '深圳市宝安区石井街道上寮社区上南工业区059号202';
$cfg_gg = '深圳百强科技有限公司';
$cfg_mc = '深圳百强科技有限公司';
$cfg_qq = '81063818';
?>